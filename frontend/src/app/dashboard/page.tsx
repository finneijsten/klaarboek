        ...
        <aside className="w-64 min-h-screen bg-white border-r border-[#E0DCD5] p-6">
          ...
          <nav className="mt-8 flex flex-col gap-2">
            {[
              ...
              { label: "Transacties", href: "/transactions", active: false },
              { label: "Facturen", href: "/invoices", active: false },
              { label: "BTW-aangifte", href: "/btw", active: false },
              { label: "Instellingen", href: "/settings", active: false },
            ].map((item) => (
              <a
                key={item.label}
                href={item.href}
